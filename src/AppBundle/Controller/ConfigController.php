...
class ConfigController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $imgform   = $this->createForm(new \AppBundle\Form\imageType(), $img);
    ...
    public function showAction(config $entity)
    {
        ...
        return $this->render('AppBundle:Config:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function updateAction(Request $request)
    {
        ...
        $this->get('session')->getFlashBag()->add('success', "Los cambios realizados se guardaron exitosamente.");
