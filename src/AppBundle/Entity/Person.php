...
class Person
{
    ...
    /**
    * @ORM\OneToMany(targetEntity="AppBundle\Entity\Antecedent", mappedBy="person", cascade={"remove", "persist"})
    */
    
    //protected $antecedents;

    /**
    * @ORM\OneToMany(targetEntity="AppBundle\Entity\Consultation", mappedBy="person", cascade={"remove", "persist"})
    */
   ...
   /**
     ...
     * Add antecedents
     *
     * @param \AppBundle\Entity\Antecedent $antecedents
     * @return Person
     */
    
    /*public function addAntecedent(\AppBundle\Entity\Antecedent $antecedents)
    {
    ...
    /*public function removeAntecedent(\AppBundle\Entity\Antecedent $antecedents)
    {
     ...
     * Add consultations
     *
     * @param \AppBundle\Entity\Consultation $consultations
     * @return Person
     */
    
    /*public function addConsultation(\AppBundle\Entity\Consultation $consultations)
    {
    ...
    /*public function removeConsultation(\AppBundle\Entity\Consultation $consultations)
    {
